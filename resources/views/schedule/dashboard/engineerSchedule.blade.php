        ...
        <div class="col">
            ...
            <div class="card card-calendar">
                ...
                <div class="card-body p-0">
                    <div class="calendar" data-toggle="calendar" id="schedule_calendar"></div>
                </div>
            </div>
            <!-- Modal - Add new event -->
            <!--* Modal header *-->
...
@push('js')
        <script src="{{ asset('argon')  }}/vendor/fullcalendar-4.4.0/packages/core/main.js"></script>
        <script src="{{ asset('argon')  }}/vendor/fullcalendar-4.4.0/packages/daygrid/main.js"></script>
