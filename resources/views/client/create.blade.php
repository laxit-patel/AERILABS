        ...
        <div class="row ">
            <div class="col-xl-12  order-xl-1">
                <div class="card bg-secondary  shadow-primary">
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('client.store') }}" id="client_form" autocomplete="off">
                            @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-5 form-group{{ $errors->has('client_name') ? ' has-danger' : '' }}">
                                    ...
                                    <div class="col-md-4 form-group{{ $errors->has('client_gestin') ? ' has-danger' : '' }} ">
                            ...
                            <div class="row">
                                ...
                                <div class="text-center">
                                    <button type="submit" class="btn btn-lg btn-block btn-success mt-4" id="client_trigger" >{{ __('Add') }}</button>
                                </div>
    ...
    @push('js')
        ...
        <script type="text/javascript">
            $('#client_trigger').click(function () {
                $('#client_trigger').attr('disabled', true);
                $('#client_form').submit();
                return true;
            });
        </script>
