...
class CreateQuotationsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('quotations', function (Blueprint $table) {
            ...
            $table->string('quotation_qty');
            $table->string('quotation_total');
            $table->enum('quotation_type',array('Draft','Initial','Revised'));
            $table->string('quotation_stack')->default(NULL);
            $table->string('quotation_predecessor')->default(NULL);
            $table->string('quotation_successor')->default(NULL);
